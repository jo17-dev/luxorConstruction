const PhoneSvg = (props)=>{
    return(
    <svg xmlns="http://www.w3.org/2000/svg" fill={props?.fill || "white"} stroke={props?.stroke || "#a93f0b"}  id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width={props.width} height={props.height}>
